...
<script src="js/bootstrap.min.js"></script>
    ...
    window.onload = function()
    {
    	...
    	<div align="center" id="storeInfo">
    		<br /><br />
    	<img src="images/perPto.jpg" class="img-circle" style="height: 150px;width: 150px;"><br />
    	<span class="text-primary"><h1>id</h1></span>
    	<span class="text-primary" ><h2>tel</h2></span>
 	</div>
 	</div>
 	<div style="width: 70%;">
